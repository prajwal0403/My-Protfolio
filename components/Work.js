	...
	return (
		<div id="projects" className="bg-primary py-5 px-5">
			<div className="container">
				...
				<div className="d-flex flex-row flex-wrap justify-content-center h5" style={{textAlign:"center"}}>
					{cards.map((value, index) => (
						<Card2
							key={index}
							title={value.title}
...
export const Card = ({ title, description, icons}) => {
	return (
		<div className="card py-3 px-3 mx-sm-4 my-4 card-work" style={{textAlign:"center",alignContent:"-moz-initial" }}>
